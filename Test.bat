...
C:\Downloads\AcroRdrDC2200120142_en_US.exe /sAll /rs /msi EULA_ACCEPT=YES
@echo Downloading Microsoft Office 365 Business
curl -O https://download.microsoft.com/download/2/7/A/27AF1BE6-DD20-4CB4-B154-EBAB8A7D4A7E/officedeploymenttool_15225-20204.exe
C:\Downloads\officedeploymenttool_15225-20204 /extract:C:\Downloads\Office365 /q /norestart
cd C:\Downloads\Office365
curl -O https://raw.githubusercontent.com/husaini-alsaid/Software-Link/main/RSPO.xml
setup.exe /download RSPO.xml
@echo Installing Microsoft Office 365 Business
setup.exe /configure RSPO.xml
@echo Go back to Office Folder
cd ..
@echo Go to Main Drive 
cd ..
